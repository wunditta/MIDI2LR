...
local KeyCode = {
  ...
  DeletePhotosKey                = '0 '..LOC("$$$/AgLibrary/Menu/Library/DeletePhotos/Key=delete"),
  DeleteRejectedKey              = '6 '..LOC("$$$/AgLibrary/Menu/Library/DeleteRejects/Key=delete"),
  CursorLeftKey                  = '0 '..LOC("$$$/MIDI2LR/Dialog/CursorLeft/Key=cursor left"),
  ReturnKey                      = '0 '..LOC("$$$/MIDI2LR/Dialog/Return/Key=return"),
}
